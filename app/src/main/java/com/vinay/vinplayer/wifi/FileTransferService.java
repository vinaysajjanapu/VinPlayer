...
public class FileTransferService extends IntentService {
    ...
    public static final String ACTION_SEND_FILE = "com.vinay.vinplayer.SEND_FILE";
    public static final String ACTION_SEND_COMMAND = "com.vinay.vinplayer.SEND_COMMAND";
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        else if(intent.getAction().equals(ACTION_SEND_COMMAND)){
            String host = intent.getExtras().getString(EXTRAS_GROUP_OWNER_ADDRESS);
            String command="ok";
            Socket socket = new Socket();
            int port = intent.getExtras().getInt(EXTRAS_GROUP_OWNER_PORT);
